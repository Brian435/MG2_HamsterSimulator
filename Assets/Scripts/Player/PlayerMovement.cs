...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float walkSpeed, runSpeed, jumpForce, rotationSpeed, FalleDamageSpeeed;
    ...
    //Funcion para la caida 
    bool FallDamage()
    {
        if (!isGrounded && characterController.velocity.y < -FalleDamageSpeeed)
        {
            return true;
        }
        else
